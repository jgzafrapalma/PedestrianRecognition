...
class DataGeneratorFINALMODEL(Sequence):
...
class DataGeneratorFINALMODELPredict(Sequence):
    def __init__(self, list_IDs, path_instances, n_frames, batch_size=32, dim=(128, 128, 32), n_channels=1, n_clases=1, shuffle=True, normalized=True):
        self.dim = dim
        self.batch_size = batch_size
        self.list_IDs = list_IDs
    ...
    def __data_generation(self, list_IDs_temp):
        ...
        for i, ID_instance in enumerate(list_IDs_temp):
            ...
            with open('RealValues.txt','a') as filehandle:
                filehandle.write(ID_instance + ": %f\n" % intention_prob)
