...
if config['Transfer_Learning_CrossingDetection_Shuffle']['path_weights'] != 'None':
    ...
    path_hyperparameters = Path(join(config['Transfer_Learning_CrossingDetection_Shuffle']['path_hyperparameters'], dataset, 'Transfer_Learning', 'CrossingDetection', 'Shuffle', tuner_type, type_model, 'No_Transfer_Learning', project_name + '.json'))
    ...
    path_output_model = Path(join(config['Transfer_Learning_CrossingDetection_Shuffle']['path_output_model'], dataset, 'Transfer_Learning', 'CrossingDetection', 'Shuffle', data_sampling, tuner_type, type_model, '05112020-184600'))
