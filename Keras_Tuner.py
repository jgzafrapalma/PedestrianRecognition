...
def run_hyperparameter_tuning():
    ...
    if not Transfer_Learning:
        ...
        elif pretex_task == 'OrderPrediction':
    ...
    # Tuner Transfer Learning          
        ...
        tuner.search(train_ids_instances, validation_ids_instances, dim, path_instances, n_frames, 1, epochs, [earlystopping, reducelronplateau])
